...
import 'package:readify_app/features/shop/data/shop_repositoryImp.dart';
...
class _ShopScreenState extends State<ShopScreen> {
  late final ShopRepositoryImpl _repo;
  late Future<List<GenreModel>> _getGenresFuture;
  ...
  void initState() {
    ...
    _repo = ShopRepositoryImpl(tokenStorage: TokenStorageService(_prefs));

    _getGenresFuture = _repo.getGenres();
  }
            ...
            children: [
              ...
              FutureBuilder<List<GenreModel>>(
                ...
                builder: (context, snapshot) {
                  ...
                  return HorizontalGenreList(genres: genres);
                },
              ),
              const SizedBox(height: 20),
