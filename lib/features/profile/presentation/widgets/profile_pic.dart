...
class ProfilePic extends StatelessWidget {
  ...
  final VoidCallback? onEdit; // null = disabled while uploading
          ...
          children: [
            ...
            Container(
              ...
              child: CircleAvatar(
                ...
                // Use a key so Flutter replaces the widget when the URL changes,
                // which forces a fresh network fetch instead of showing the cache.
                ...
                onBackgroundImageError: (_, __) {}, // silently fallback
              ),
            ),
            ...
            Positioned(
              ...
              child: GestureDetector(
                onTap: onEdit, // null disables tap automatically
                child: AnimatedOpacity(
                  opacity: onEdit != null ? 1.0 : 0.4,
                  ...
                  child: Container(
                    ...
                    child: Center(
                      child: SvgPicture.string(_cameraIcon, width: 20),
                    ),
                  ),
                ),
              ),
